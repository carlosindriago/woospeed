    ...
    <?php if ($needs_migration): ?>
        <div
            ...
            <p style="font-size: 11px; color: #856404; margin-top: 10px;">*
                <?php _e('This may take a few seconds depending on the number of orders.', 'woospeed-analytics'); ?></p>
        </div>
    <?php endif; ?>
    ...
    <div style="display: flex; gap: 20px; margin-top: 20px;">
        ...
        <div
            ...
            <p style="font-size: 11px; color: #666; margin-top: 5px;">*
                <?php _e('Orders will use these products.', 'woospeed-analytics'); ?></p>
        </div>
        ...
        <div
            ...
            <p><?php _e('Generates <b>5,000 Real Orders</b> using products from step 1.', 'woospeed-analytics'); ?>
                <br><?php _e('Reflects real load.', 'woospeed-analytics'); ?></p>
            ...
            <p style="font-size: 11px; color: #666; margin-top: 5px;">*
                <?php _e('Will run in 10 batches of 500.', 'woospeed-analytics'); ?></p>
        </div>
